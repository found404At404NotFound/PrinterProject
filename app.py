...
CORS(app,allow_headers=["Content-Type", "Authorization"],origins=["http://127.0.0.1:6942", "http://http://127.0.0.1:5500", "http://localhost:5500", "http://127.0.0.1:5500"], supports_credentials=True)
